...
export default function Login() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      // 1. Kaydi Token-ka iyo xogta qofka
      localStorage.setItem("token", response.data.token);
      localStorage.setItem("user", JSON.stringify(response.data.user));

      alert("Si guul leh ayaad u gashay!");

      // 2. U dir Dashboard-ka saxda ah
      ...
      setError(err.response?.data?.message || "Email ama Password khaldan");
    } finally {
      setLoading(false);
    }
  };
        ...
        <CardContent className="p-8 pt-4">
          <form className="space-y-4" onSubmit={handleLogin}>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input 
                  ...
                  className="pl-12 h-12 bg-slate-50 border-none rounded-xl focus-visible:ring-blue-500"
                  required
            ...
            <Button 
              type="submit" 
              disabled={loading}
              className="w-full h-12 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-xl shadow-lg shadow-blue-100 transition-all mt-2"
            >
